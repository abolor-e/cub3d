...
{
	ft_to_image(cub3d, &cub3d->texture[0].text, "textures/greystone.xpm");
	ft_to_image(cub3d, &cub3d->texture[1].text, "textures/greystone.xpm");
	ft_to_image(cub3d, &cub3d->texture[2].text, "textures/greystone.xpm");
	ft_to_image(cub3d, &cub3d->texture[3].text, "textures/greystone.xpm");
}
